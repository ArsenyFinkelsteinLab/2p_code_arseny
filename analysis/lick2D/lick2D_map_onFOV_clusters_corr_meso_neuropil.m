function lick2D_map_onFOV_clusters_corr_meso_neuropil(key, flag_plot_clusters_individually, n_clust, M_all, dir_current_fig)
close all;
...
rel1 = ((IMG.ROI*POP.ROIClusterCorrNeuropil*IMG.PlaneCoordinates) & IMG.ROIGood & key) & 'heirar_cluster_percent>=1';
