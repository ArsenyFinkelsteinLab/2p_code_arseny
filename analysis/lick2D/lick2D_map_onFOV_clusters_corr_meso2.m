function lick2D_map_onFOV_clusters_corr_meso2(key, flag_plot_clusters_individually, n_clust, M_all)
close all;
...
filename=[];
dir_current_fig = [dir_base  '\Lick2D\brain_maps\clusters_corr2\'];
rel = IMG.ROI &  ((POP.ROIClusterCorr2& key) & 'heirar_cluster_percent>=1')  & IMG.ROIGood ;


rel1 = ((IMG.ROI*POP.ROIClusterCorr2*IMG.PlaneCoordinates) & IMG.ROIGood & key) & 'heirar_cluster_percent>=1';
