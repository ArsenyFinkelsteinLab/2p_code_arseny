function lick2D_map_onFOV_angles__meso(key, dir_current_fig, flag_spikes)
close all;
% clf;
...
if flag_spikes==1
    ...
    rel_rois=  IMG.ROIGood & (rel_data  & key  & 'theta_tuning_odd_even_corr>0.5' & 'goodness_of_fit_vmises>0.5' & 'rayleigh_length<0.2');
