function population_DistanceTuning3
close all

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Lick2D\population\distance_dependence_etl3\'];
filename = 'population_summary2';
...
rel_data= (LICK2D.DistanceCorrConcatSpikes2 *EXP2.SessionID & 'num_cells_included>=200') - IMG.Mesoscope;
D=fetch(rel_data	 & key,'*');
bins_lateral_distance=D(1).lateral_distance_bins;
