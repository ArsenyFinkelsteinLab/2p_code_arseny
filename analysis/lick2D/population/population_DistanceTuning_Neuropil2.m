function population_DistanceTuning_Neuropil2
close all

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Lick2D\population\distance_dependence2\'];
filename = 'population_summary_dff_neuropil';



key.odd_even_corr_threshold=0;
rel_data= (LICK2D.DistanceCorrConcatNeuropil2 *EXP2.SessionID & 'num_cells_included>=200') - IMG.Mesoscope;
