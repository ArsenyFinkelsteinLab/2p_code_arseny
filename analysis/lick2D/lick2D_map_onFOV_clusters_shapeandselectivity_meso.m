function lick2D_map_onFOV_clusters_shapeandselectivity_meso(key, flag_plot_clusters_individually)
close all;
...
filename=[];
dir_current_fig = [dir_base  '\Lick2D\population\onFOV_clusters_shapeandselectivity_meso\bins' num2str(key.number_of_bins) '\'];
