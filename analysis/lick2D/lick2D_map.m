...
flag_all_or_signif=0;  % 1 all cells, 2 signif cells in 2D lick maps, 3 signf cells in PSTH motor responses
...
if flag_all_or_signif ==0
    ...
    rel= ANLI.ROILick2Dmap * ANLI.ROILick2Dangle * ANLI.ROILick2DPSTH & IMG.ROIGood & key;
