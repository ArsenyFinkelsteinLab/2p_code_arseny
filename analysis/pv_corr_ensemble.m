...
dir_save_figure=['Z:\users\Arseny\Projects\Learning\imaging2p\Results\PV_corr_intersect_ensemble_binarize_before\AF09_anm437545\'];
...
for i=1:1:numel(date)
    close all;
    fn_pv_corr_ensemble(key, date{i}, dir_save_figure,  clustering_option_name, rel, flag_update_cluster_group_table)
end
