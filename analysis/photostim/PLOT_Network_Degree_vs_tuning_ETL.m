...
rel_session = EXP2.Session & (STIMANAL.OutDegreeETL & IMG.Volumetric) & (EXP2.SessionEpoch& 'session_epoch_type="spont_only"') & (STIMANAL.NeuronOrControl5ETL & 'neurons_or_control=1' & 'num_targets>=30');
...
for i_s = 1:1:rel_session.count
    ...
    k_s = sessions(i_s);
    rel_degree = STIMANAL.OutDegree*STIM.ROIResponseDirect5ETL  & (STIMANAL.NeuronOrControl5ETL & k_neurons_or_control) & k_degree & k_s;
    k_s;
