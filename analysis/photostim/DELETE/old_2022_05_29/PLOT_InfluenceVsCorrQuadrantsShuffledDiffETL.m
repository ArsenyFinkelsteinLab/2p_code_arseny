function PLOT_InfluenceVsCorrQuadrantsShuffledDiffETL()
close all

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Photostim\Connectivity_ETL\'];
filename = 'infleunce_vs_psth_quadrant';

rel_data = STIMANAL.InfluenceVsCorrQuadrantsETL & 'session_epoch_number<3' & 'num_targets>=30' & 'num_pairs>=5000' ;
rel_shuffled = STIMANAL.InfluenceVsCorrQuadrantsShuffledETL  & 'session_epoch_number<3' & 'num_targets>=30' & 'num_pairs>=5000';
