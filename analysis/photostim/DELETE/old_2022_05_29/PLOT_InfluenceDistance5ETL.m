function PLOT_InfluenceDistance5ETL()
...
rel_data = (STIMANAL.InfluenceDistance55ETL & 'flag_divide_by_std=0' & 'flag_withold_trials=0' & 'flag_normalize_by_total=1') ...
    &  (STIMANAL.SessionEpochsIncluded& IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' & 'session_epoch_number<=3' ...
    & (STIMANAL.NeuronOrControl5ETL & 'neurons_or_control=1' & 'num_targets>=10') ...
    & (STIMANAL.NeuronOrControl5ETL & 'neurons_or_control=0' & 'num_targets>=10'));
