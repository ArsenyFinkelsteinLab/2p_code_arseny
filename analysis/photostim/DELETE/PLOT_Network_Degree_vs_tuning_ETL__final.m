...
for i_s = 1:1:rel_session.count
    ...
    k_s = sessions(i_s);
    rel_degree = STIMANAL.OutDegree*STIM.ROIResponseDirect2  & (STIMANAL.NeuronOrControl2 & k_neurons_or_control) & k_degree & k_s & IMG.ROIInclude;
    ...
    rel_signal1 = LICK2D.ROILick2DangleStatsSpikes3bins  & k_s & key_epoch & IMG.ROIInclude;
%     rel_signal1 = IMG.ROIdeltaFStats & k_s & key_epoch;
%     rel_signal1 = LICK2D.ROILick2DmapStatsSpikes3bins & k_s & key_epoch;
    rel_signal2 = LICK2D.ROILick2DPSTHStatsSpikes  & k_s & key_epoch & IMG.ROIInclude;
    rel_signal3 = LICK2D.ROILick2DangleStatsSpikes3bins & k_s & key_epoch & IMG.ROIInclude;
%     rel_signal4 = LICK2D.ROILick2DPSTHStatsSpikes & k_s & key_epoch;
    rel_signal4 = LICK2D.ROILick2DangleStatsSpikes3bins & k_s & key_epoch & IMG.ROIInclude;

    rel_corr_local = POP.ROICorrLocalPhoto2  & k_s & k_corr_local & key_epoch & IMG.ROIInclude;
    ...
    DATA_SIGNAL1 = fetchn(rel_signal1, 'rayleigh_length_regular');
...
%     DATA_SIGNAL1 = fetchn(rel_signal1, 'mean_dff');
    DATA_SIGNAL2 = struct2table(fetch(rel_signal2, '*'));
     DATA_SIGNAL3 = fetchn(rel_signal3, 'theta_tuning_odd_even_corr_regular','ORDER BY roi_number');
...
%     DATA_SIGNAL4 = fetchn(rel_signal4, 'psth_position_concat_regular_odd_even_corr','ORDER BY roi_number');
    DATA_SIGNAL4 = fetchn(rel_signal4, 'goodness_of_fit_vmises_regular','ORDER BY roi_number');
