...
rel_data = STIMANAL.InfluenceVsCorrTraceBehav2 & 'session_epoch_number<3' & 'num_targets>=30';
rel_shuffled = STIMANAL.InfluenceVsCorrTraceBehavShuffled2  & 'session_epoch_number<3' & 'num_targets>=30';
