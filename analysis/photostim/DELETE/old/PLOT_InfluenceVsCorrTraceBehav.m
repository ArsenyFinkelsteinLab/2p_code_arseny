function PLOT_InfluenceVsCorrTraceBehav()
close all

rel_data = STIMANAL.InfluenceVsCorrTraceBehav& 'session_epoch_number<3' & 'num_targets>=30';
rel_shuffled = STIMANAL.InfluenceVsCorrTraceBehavShuffled  & 'session_epoch_number<3' & 'num_targets>=30';
...
for i_c = 1:1:numel(num_svd_components_removed_vector_corr)
    ...
    bins_influence_centers = bins_influence_edges(1:1:end-1) + diff(bins_influence_edges);
