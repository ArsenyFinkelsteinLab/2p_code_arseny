function PLOT_Network_Degree_vs_tuning_ETL2()
clf
...
rel_session = EXP2.Session & (STIMANAL.OutDegree3 & IMG.Volumetric) & (EXP2.SessionEpoch& 'session_epoch_type="spont_only"') & (STIMANAL.NeuronOrControl3 & 'neurons_or_control=1' & 'num_targets>=30');
...
for i_s = 1:1:rel_session.count
    ...
    k_s = sessions(i_s);
    rel_degree = STIMANAL.OutDegree3*STIM.ROIResponseDirect3  & (STIMANAL.NeuronOrControl3 & k_neurons_or_control) & k_degree & k_s;
    k_s;
