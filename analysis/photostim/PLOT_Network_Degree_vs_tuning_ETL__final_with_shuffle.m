function PLOT_Network_Degree_vs_tuning_ETL__final_with_shuffle()
clf

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Photostim\Connectivity\'];
filename = 'network_degree_vs_tuning_shuffled';
num_shuffles=100;
...
for i_s = 1:1:rel_session.count
    ...
    k_s = sessions(i_s);
    rel_degree = STIMANAL.OutDegree*STIM.ROIResponseDirect2  & (STIMANAL.NeuronOrControl2 & k_neurons_or_control) & k_degree & k_s & rel_include;
    k_s;
    ...
    rel_signal1 = LICK2D.ROILick2DmapStatsSpikes3bins & k_s & key_epoch & rel_include;
