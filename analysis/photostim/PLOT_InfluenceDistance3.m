function PLOT_InfluenceDistance3()
...
rel_data = (STIMANAL.InfluenceDistance3 & 'flag_divide_by_std=0' & 'flag_withold_trials=0' & 'flag_normalize_by_total=1') ...
    &  (STIMANAL.SessionEpochsIncludedFinal & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' )  ...
    & (STIMANAL.NeuronOrControlNumber3 & 'num_targets_neurons>=50') ...
    & (STIMANAL.NeuronOrControlNumber3 & 'num_targets_controls>=50');
