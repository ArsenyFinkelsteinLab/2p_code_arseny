...
rel_data = STIMANAL.InfluenceVsCorrAngle & 'session_epoch_number<3';
rel_shuffled = STIMANAL.InfluenceVsCorrAngleShuffled  & 'session_epoch_number<3';
