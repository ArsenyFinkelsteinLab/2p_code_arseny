function PLOT_InfluenceVsCorrPSTHShuffledDiff()
close all

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\'];
filename = 'influence_vs_tuning_by_psth_stability';
...
rel_data = STIMANAL.InfluenceVsCorrPSTH  & 'num_pairs>=0'  & 'num_targets>=50'...
...
rel_shuffled = STIMANAL.InfluenceVsCorrPSTHShuffled  & 'num_pairs>=0'  & 'num_targets>=50'...
    &  (STIMANAL.SessionEpochsIncludedFinal & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1')   ...;
    %         & (STIMANAL.NeuronOrControlNumber2 & 'num_targets_neurons>=50') ...
%     & (STIMANAL.NeuronOrControlNumber2 & 'num_targets_controls>=50');
...
for i_c = 1:1:numel(num_svd_components_removed_vector_corr)
    ...
    shadedErrorBar(bins_corr_centers,y_mean,y_stem,'lineprops',{'-','Color',[1 0 0]})
    plot(bins_corr_centers,y_mean,'.-','Color',[1 0 0])
