...
filename = 'connectivity_vs_tuning_by_psth_stability';
title_string = 'Tuning to response time\n';

key.neurons_or_control=1;
key.response_p_val=1;

rel_data = STIMANAL.InfluenceVsCorrPSTH*EXP2.SessionID & key & 'num_pairs>=0' & 'num_targets>=50' ...
    &  (STIMANAL.SessionEpochsIncludedFinal & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' & 'session_epoch_number=2')   ...;
 
rel_shuffled = STIMANAL.InfluenceVsCorrPSTHShuffled*EXP2.SessionID & key & 'num_pairs>=0' & 'num_targets>=50' ...
    &  (STIMANAL.SessionEpochsIncludedFinal & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' & 'session_epoch_number=2')   ...;
