function PLOT_InfluenceDistance7()
...
rel_data = (STIMANAL.InfluenceDistance7 & 'flag_divide_by_std=0' & 'flag_withold_trials=1' & 'flag_normalize_by_total=1') ...
    &  (STIMANAL.SessionEpochsIncluded& IMG.Volumetric & 'stimpower=150' & 'flag_include=1' & 'session_epoch_number<=3' ...
    & (STIMANAL.NeuronOrControl7 & 'neurons_or_control=1' & 'num_targets>=10') ...
    & (STIMANAL.NeuronOrControl7 & 'neurons_or_control=0' & 'num_targets>=10'));
