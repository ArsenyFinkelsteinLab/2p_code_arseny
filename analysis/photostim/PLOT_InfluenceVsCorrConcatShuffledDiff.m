...
filename = 'influence_vs_tuning_by_concatenated_psth_stability';
...
rel_data = STIMANAL.InfluenceVsCorrConcat  & 'num_pairs>=0' & 'num_targets>=50' ...
...
rel_shuffled = STIMANAL.InfluenceVsCorrConcatShuffled & 'num_pairs>=0' & 'num_targets>=50' ...
    &  (STIMANAL.SessionEpochsIncludedFinal & IMG.Volumetric & 'stimpower>=100' & 'flag_include=1')   ...;
    %     & (STIMANAL.NeuronOrControlNumber2 & 'num_targets_neurons>=0') ...
%     & (STIMANAL.NeuronOrControlNumber2 & 'num_targets_controls>=0');
