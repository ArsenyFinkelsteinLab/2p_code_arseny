function PLOT_InfluenceDistanceLateral()
...
rel_data = (STIMANAL.InfluenceDistance & 'flag_divide_by_std=0' & 'flag_withold_trials=1' & 'flag_normalize_by_total=1') ...
    &  (STIMANAL.SessionEpochsIncluded & 'stimpower_percent=15' & 'flag_include=1' & 'session_epoch_number<=8' ...
...
OUT1=fn_PLOT_CoupledResponseDistanceLateral_averaging(D1,flag_response);
...
OUT2=fn_PLOT_CoupledResponseDistanceLateral_averaging(D2,flag_response);
...
hold on
plot(xl, [0 0],'-k')
shadedErrorBar(OUT1.distance_lateral_bins_centers,OUT1.marginal_lateral_mean,OUT1.marginal_lateral_stem,'lineprops',{'-','Color',[1 0 0]})
