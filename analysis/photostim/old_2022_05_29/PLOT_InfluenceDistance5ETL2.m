function PLOT_InfluenceDistance5ETL2()
...
rel_data = (STIMANAL.InfluenceDistance55ETL2 & 'flag_divide_by_std=0' & 'flag_withold_trials=0' & 'flag_normalize_by_total=1') ...
    &  (STIMANAL.SessionEpochsIncluded& IMG.Volumetric & 'stimpower>=100' & 'flag_include=1' & 'session_epoch_number<=3' ...
    & (STIMANAL.NeuronOrControl5ETL2 & 'neurons_or_control=1' & 'num_targets>=50') ...
    & (STIMANAL.NeuronOrControl5ETL2 & 'neurons_or_control=0' & 'num_targets>=0'));
