function PLOT_InfluenceVsCorrAngleShuffledDiff()
close all

rel_data = STIMANAL.InfluenceVsCorrAngle & 'session_epoch_number<7' & 'num_targets>30';
rel_shuffled = STIMANAL.InfluenceVsCorrAngleShuffled  & 'session_epoch_number<7' & 'num_targets>30';
