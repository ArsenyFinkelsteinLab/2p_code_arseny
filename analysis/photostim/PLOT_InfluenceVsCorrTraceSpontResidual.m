...
rel_data_neurons_residual = STIMANAL.InfluenceVsCorrTraceSpontResidual & 'session_epoch_number<3' & 'num_targets>=30' & 'neurons_or_control=1' & key;
rel_data_control_residual = STIMANAL.InfluenceVsCorrTraceSpontResidual & 'session_epoch_number<3' & 'num_targets>=30' & 'neurons_or_control=0' & key;
