function PLOT_InfluenceVsCorrQuadrantsResidual()
% close all
clf;

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Photostim\influence_vs_corr\populations_plots\'];
filename = 'InfluenceVsCorrQuadrantsResidual'

key.num_svd_components_removed_corr=0;

rel_data_neurons_residual = STIMANAL.InfluenceVsCorrQuadrantsResidual & 'session_epoch_number<3' & 'num_targets>=30' & 'num_pairs>=2000' &  'neurons_or_control=1' & key;
rel_data_control_residual = STIMANAL.InfluenceVsCorrQuadrantsResidual & 'session_epoch_number<3' & 'num_targets>=30' & 'num_pairs>=2000' & 'neurons_or_control=0' & key;

% rel_data_neurons_raw = STIMANAL.InfluenceVsCorrTraceSpont & 'session_epoch_number<3' & 'num_targets>=30' & 'neurons_or_control=1' & key;
% rel_data_neurons_shuffled = STIMANAL.InfluenceVsCorrTraceSpontShuffled & 'session_epoch_number<3' & 'num_targets>=30' & 'neurons_or_control=1' & key;
