function PLOT_Network_Degree_vs_tuning_ETL3()
clf
...
for i_s = 1:1:rel_session.count
    ...
    k_s = sessions(i_s);
    rel_degree = STIMANAL.OutDegree3 *STIM.ROIResponseDirect3  & (STIMANAL.NeuronOrControl3 & k_neurons_or_control) & k_degree & k_s &'out_degree_excitatory>=0' &sprintf('p_val<=%.5f',p_val);
    k_s;
