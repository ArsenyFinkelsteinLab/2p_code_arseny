function [StimStat, StimTrace] = fn_compute_photostim_delta_influence2 (f_trace, photostim_start_frame,baseline_start_frame, timewind_response,time)
...
% if    StimStat.response_p_value1_odd<=0.01 & StimStat.response_mean_odd>0 %& StimStat.response_p_value1<0.01 %&  (StimStat.response_min_odd<StimStat.non_response_min_odd) 
% %     a=1
