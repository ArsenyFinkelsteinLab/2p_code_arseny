function [StimStat, StimTrace] = fn_compute_photostim_delta_influence (f_trace, photostim_start_frame,baseline_start_frame, timewind_response,time)
...
% plot(photostim_start_frame+3,f_trace(photostim_start_frame+2),'oy');
% 
% 
...
% plot(time, mean(F(idx_odd_trials,:),1),'-r')
% plot(time, mean(F(idx_even_trials,:),1),'-b')
% 
% 
...
% if    StimStat.response_p_value1_odd<=0.01 & StimStat.response_mean_odd>0 %&  (StimStat.response_min_odd<StimStat.non_response_min_odd) 
% %     a=1
