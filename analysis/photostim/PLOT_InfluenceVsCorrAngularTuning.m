function PLOT_InfluenceVsCorrAngularTuning()
close all

dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
dir_current_fig = [dir_base  '\Photostim\Connectivity\'];
filename = 'infleunce_vs_angular_tuning_not_difference';

rel_data = STIMANAL.InfluenceVsCorrAngularTuning & 'session_epoch_number<3' & 'num_targets>=30' & 'num_pairs>=2000' ;
rel_shuffled = STIMANAL.InfluenceVsCorrAngularTuningShuffled  & 'session_epoch_number<3' & 'num_targets>=30' & 'num_pairs>=2000';
