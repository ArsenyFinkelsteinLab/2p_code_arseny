function pv_corr_ensemble_extraction_avg_maps()
close all;
anm=437545;
...
clustering_option_name = 'average correlations between trial-types'; 
...
for i=1:1:numel(date)
    close all;
    fn_pv_corr_ensemble_extraction_avg_correlation_mps(key, date{i}, dir_save_figure,  clustering_option_name, rel, flag_update_cluster_group_table)
end
