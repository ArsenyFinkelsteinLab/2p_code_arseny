function PLOT_SVD_Variance_and_SpatialScale_and_TemporalScale()
...
set(gca, 'XScale','log', 'YScale','log')
xlabel('PC dimension');
ylabel('Temporal scale (s)');
box off
text(1.5,100,'Behavior', 'Color', [0 0 1]);
text(1.5,50,'Spontaneous', 'Color', [1 0 0]);
xlim([1 100])
set(gca,'XTick', [1,10,100,1000], 'Ytick', [1 10 100])
% set(gca,'XTick', [1,10,100,1000], 'Ytick', [250 500 1000 2000])
% ylim([200 2000])
