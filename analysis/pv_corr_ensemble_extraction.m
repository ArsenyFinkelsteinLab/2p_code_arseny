function pv_corr_ensemble_extraction()
close all;
anm=437545;
...
flag_update_cluster_group_table=1;


dir_save_figure=['Z:\users\Arseny\Projects\Learning\imaging2p\Results\PV_corr_intersect_ensemble_extraction\AF09_anm437545\'];
...
if flag_update_cluster_group_table~=0
    ...
    del(ANLI.ROICluster & k);
end

for i=1:1:numel(date)
    close all;
    fn_pv_corr_ensemble_extraction(key, date{i}, dir_save_figure,  clustering_option_name, rel, flag_update_cluster_group_table)
end
