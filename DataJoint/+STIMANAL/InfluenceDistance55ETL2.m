...
classdef InfluenceDistance55ETL2 < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1') & STIM.ROIInfluence5ETL;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            rel=STIM.ROIInfluence5ETL;
...
%             flag_divide_by_std = [0]; % 1 divide the response by std. 0 don't divide
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_direct= STIMANAL.NeuronOrControl5ETL2 & kkk;
