...
classdef Target2AllCorrConcat2 < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="behav_only"')  & (EXP2.SessionEpoch & LICK2D.ROILick2DContactenated)) & STIM.ROIResponseDirect2;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_data = LICK2D.ROILick2DContactenated & rel_roi;
