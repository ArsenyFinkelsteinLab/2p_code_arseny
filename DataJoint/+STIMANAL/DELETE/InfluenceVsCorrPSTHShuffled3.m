...
classdef InfluenceVsCorrPSTHShuffled3 < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            % bins
            bins_corr = [-1, -0.25, 0.25, 0.5, 1]; 
            bins_influence = [-inf, 0, 0.25, 0.5, inf];
            ...
            dir_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\single_sessions\tuning_by_psth_stability\shuffled\'];
