...
classdef NeuronOrControl3 < dj.Imported
    properties
        keySource = EXP2.SessionEpoch & 'flag_photostim_epoch =1' & IMG.ROI & STIM.ROIResponseDirect3 & (STIMANAL.SessionEpochsIncludedFinal & 'flag_include=1');
    end
