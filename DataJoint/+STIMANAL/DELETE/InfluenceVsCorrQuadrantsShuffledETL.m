...
classdef InfluenceVsCorrQuadrantsShuffledETL < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrQuadrantsETL & STIM.ROIInfluence5ETL;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_ETL\corr_quadrants\shuffled\'];
            session_date = fetch1(EXP2.Session & key,'session_date');
            
            
            rel_data_corr =STIMANAL.Target2AllCorrQuadrantsETL;
            rel_data_influence=STIM.ROIInfluence5ETL;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target = IMG.PhotostimGroup & (STIMANAL.NeuronOrControl5ETL2 & key);
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect5ETL2 &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_quadrants_odd_even_corr>=0.5'));
                ...
                for i_p=1:1:numel(p_val)
                    ...
                    roi_psth_signif = fetchn(rel_data_signal & k_psth & rel_roi & 'psth_quadrants_odd_even_corr>=0.5', 'roi_number', 'ORDER BY roi_number');
