...
classdef InfluenceVsCorrConcatShuffled3 < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            bins_influence = [-inf,-0.2, 0, 0.25, 0.5, 0.75, inf];
            ...
            dir_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\single_sessions\tuning_by_concatenated_psth_stability\shuffled\'];
            session_date = fetch1(EXP2.Session & key,'session_date');
            
            
            rel_data_corr =STIMANAL.Target2AllCorrConcat & rel_include;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirectUnique &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_position_concat_regular_odd_even_corr>=0.25'));
