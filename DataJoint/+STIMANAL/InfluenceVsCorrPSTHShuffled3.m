...
classdef InfluenceVsCorrPSTHShuffled3 < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrPSTH3 & STIM.ROIInfluence3;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_new\corr_psth3\shuffled\'];
            session_date = fetch1(EXP2.Session & key,'session_date');
            
            
            rel_data_corr =STIMANAL.Target2AllCorrPSTH3;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect3 &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_odd_even_corr>=0.5'));
