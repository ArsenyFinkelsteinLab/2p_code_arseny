...
classdef InfluenceVsCorrQuadrantsFar < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            minimal_distance=100; %um, lateral;  exlude all cells within minimal distance from target
            maximal_distance=inf; %um lateral;  exlude all cells further than maximal distance from target
...
%             bins_influence = [-inf,linspace(-0.1,0.4,6),inf];
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr\corr_quadrants_far\'];
