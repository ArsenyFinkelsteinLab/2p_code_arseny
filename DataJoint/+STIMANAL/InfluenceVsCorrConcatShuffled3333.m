...
classdef InfluenceVsCorrConcatShuffled3333 < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrConcat3 & STIM.ROIInfluence3;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            % bins
            bins_corr = linspace(-1,1,10); % if there is no SVD component/s subtraction
            bins_corr([2,4])=[];
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_new\corr_concat333\shuffled\'];
            session_date = fetch1(EXP2.Session & key,'session_date');
            
            
            rel_data_corr =STIMANAL.Target2AllCorrConcat3;
            rel_data_influence=STIM.ROIInfluence3;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target = IMG.PhotostimGroup & (STIMANAL.NeuronOrControl3 & key);
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect3 &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_position_concat_regularreward_odd_even_corr>=0.25'));
                ...
                for i_p=1:1:numel(p_val)
                    ...
                    roi_psth_signif = fetchn(rel_data_signal & k_psth & rel_roi & 'psth_position_concat_regularreward_odd_even_corr>=0.25', 'roi_number', 'ORDER BY roi_number');
