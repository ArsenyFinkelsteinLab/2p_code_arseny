...
classdef InfluenceVsCorrTraceSpontResidualETL < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            minimal_distance=25; %um, exclude all cells within minimal distance from target
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_ETL\corr_trace_spont\residual\'];
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target = IMG.PhotostimGroup & (STIMANAL.NeuronOrControl5ETL & key);
                rel_data_influence=STIM.ROIInfluence5ETL   & rel_target & 'num_svd_components_removed=0';
                ...
                for i_p=1:1:numel(p_val)
                    ...
                    for i_c = 1:1:numel(num_svd_components_removed_vector_corr)
                        ...
                        rel_data_corr=STIMANAL.Target2AllCorrTraceSpontETL & rel_target & 'threshold_for_event=0' & key_component_corr;
