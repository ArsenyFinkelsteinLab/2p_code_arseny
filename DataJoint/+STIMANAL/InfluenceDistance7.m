...
classdef InfluenceDistance7 < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1') & STIM.ROIInfluence7;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            rel=STIM.ROIInfluence7;
            ...
            pval=[0.0001, 0.001, 0.01, 0.05, 0.1,  1];
...
%             flag_divide_by_std = [0]; % 1 divide the response by std. 0 don't divide
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_direct= STIMANAL.NeuronOrControl7 & kkk;
