...
classdef InfluenceVsCorrAngleShuffled < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrAngle & STIM.ROIInfluence2 & STIMANAL.NeuronOrControl;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_fig = [dir_base  '\Photostim\Connectivity_vs_Tuning\single_sessions\tuning_by_preferred_angle\shuffled\'];
