...
classdef Target2AllCorrTraceSpont < dj.Computed
     properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & STIM.ROIInfluence & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="spont_only"')  & (EXP2.SessionEpoch & 'session_epoch_type="spont_photo"'));
    end
