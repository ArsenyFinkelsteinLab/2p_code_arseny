...
classdef InfluenceVsCorrQuadrantsShuffled < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrQuadrants & STIM.ROIInfluence;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect & 'flag_zscore=1' &  rel_target) &    (IMG.ROI &  (LICK2D.ROILick2DQuadrants & k_psth & 'psth_odd_even_corr>=0.5'));
