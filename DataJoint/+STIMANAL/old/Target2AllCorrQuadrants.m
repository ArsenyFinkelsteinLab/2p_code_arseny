...
classdef Target2AllCorrQuadrants < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="behav_only"')  & (EXP2.SessionEpoch & LICK2D.ROILick2DQuadrants)) & STIM.ROIResponseDirect;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            %% Loading Data
            rel_data = LICK2D.ROILick2DQuadrants & rel_roi;
