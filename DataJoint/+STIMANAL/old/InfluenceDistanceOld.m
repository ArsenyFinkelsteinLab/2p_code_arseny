...
classdef InfluenceDistance < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1') & IMG.FOVEpoch & STIM.ROIInfluence;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            rel=STIM.ROIInfluence;
            %             distance_lateral_bins = [0:25:225,250:50:500]; % microns
            distance_lateral_bins = [0:25:500]; % microns
            column_radius =100; % microns
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                parfor i_c = 1:1:numel(num_svd_components_removed_vector)
                    kk=key;
