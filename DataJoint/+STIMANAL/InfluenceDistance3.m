...
classdef InfluenceDistance3 < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1') & STIM.ROIResponseDirect3 & (STIMANAL.SessionEpochsIncludedFinal & 'flag_include=1');
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            rel=STIM.ROIInfluence3;
...
%             flag_divide_by_std = [0]; % 1 divide the response by std. 0 don't divide
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_direct= STIMANAL.NeuronOrControl3 & kkk;
