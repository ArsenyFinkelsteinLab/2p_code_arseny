...
classdef InfluenceVsCorrPSTHShuffledETL < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrPSTHETL & STIM.ROIInfluence5ETL;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_data_corr =STIMANAL.Target2AllCorrPSTHETL;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect5ETL2 &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_odd_even_corr>=0.5'));
