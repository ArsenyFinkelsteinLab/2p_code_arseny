...
classdef InfluenceVsCorrConcatShuffled2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_new\corr_concat2\shuffled\'];
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect2 &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_position_concat_regularreward_odd_even_corr>=0.25'));
