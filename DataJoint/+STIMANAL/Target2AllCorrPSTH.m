...
classdef Target2AllCorrPSTH < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="behav_only"')  & (EXP2.SessionEpoch & LICK2D.ROILick2DPSTHSpikes)) & STIM.ROIResponseDirectUnique	;
    end
