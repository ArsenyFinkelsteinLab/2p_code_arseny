...
classdef InfluenceVsCorrAngle33 < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrAngle3 & STIM.ROIInfluence3;
    end
...
%             bins_corr = linspace(0,180,8); 
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_new\corr_angle33\'];
