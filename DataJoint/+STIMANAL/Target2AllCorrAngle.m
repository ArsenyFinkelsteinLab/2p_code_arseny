...
classdef Target2AllCorrAngle < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & STIM.ROIResponseDirect & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="behav_only"')  & (EXP2.SessionEpoch & LICK2D.ROILick2DangleSpikesPhoto));
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            %% Loading Data
            rel_data = LICK2D.ROILick2DangleSpikesPhoto & rel_roi;
            rel_photostim =IMG.PhotostimGroup*(STIM.ROIResponseDirect & 'flag_zscore=1') & key;
            ...
            PSTH=cell2mat(fetchn(rel_data,'theta_tuning_curve_vmises','ORDER BY roi_number'));
