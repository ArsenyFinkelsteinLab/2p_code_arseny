...
classdef Target2AllCorrConcat < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="behav_only"')  & (EXP2.SessionEpoch & LICK2D.ROILick2DmapPSTHSpikes3bins)) & STIM.ROIResponseDirectUnique;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_data = LICK2D.ROILick2DmapPSTHSpikes3bins & rel_roi;
            ...
            temp=fetchn(rel_data,'psth_per_position_regular','ORDER BY roi_number');
