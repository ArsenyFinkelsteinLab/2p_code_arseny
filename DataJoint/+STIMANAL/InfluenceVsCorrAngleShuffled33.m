...
classdef InfluenceVsCorrAngleShuffled33 < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrAngle & STIM.ROIInfluence3;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            bins_corr = linspace(0,180,7);
            bins_influence = [-inf,linspace(-0.15,0.15,6),inf];
            
            %             distance_lateral_bins = [0,10:20:500,inf]; % microns
            distance_lateral_bins = [0:10:500,inf]; % microns
            
            
            
            dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_new\corr_angle33\shuffled\'];
            session_date = fetch1(EXP2.Session & key,'session_date');
            
            
            rel_data_corr =STIMANAL.Target2AllCorrAngle3;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect3  &  rel_target) &    (IMG.ROI &  (LICK2D.ROILick2DangleSpikes & k_psth & 'goodness_of_fit_vmises>=0.25'));
