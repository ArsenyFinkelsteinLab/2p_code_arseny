...
classdef InfluenceVsCorrConcatShuffled6 < dj.Computed
    properties
        keySource = EXP2.SessionEpoch & STIMANAL.Target2AllCorrConcat2 & STIM.ROIInfluence2;
    end
...
%             bins_corr = [linspace(-1,1,7)]; 
            ...
            dir_fig = [dir_base  '\Photostim\influence_vs_corr_new\corr_concat6\shuffled\'];
            session_date = fetch1(EXP2.Session & key,'session_date');
            
            
            rel_data_corr =STIMANAL.Target2AllCorrConcat2;
            rel_data_influence=STIM.ROIInfluence2;
            rel_data_signal = LICK2D.ROILick2DContactenated;
            k_psth =key;
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_target_signif_by_psth = (STIM.ROIResponseDirect2 &  rel_target) &    (IMG.ROI &  (rel_data_signal & k_psth & 'psth_position_concat_regularreward_odd_even_corr>=0.5'));
                ...
                for i_p=1:1:numel(p_val)
                    ...
                    roi_psth_signif = fetchn(rel_data_signal & k_psth & rel_roi & 'psth_position_concat_regularreward_odd_even_corr>=0.5', 'roi_number', 'ORDER BY roi_number');
