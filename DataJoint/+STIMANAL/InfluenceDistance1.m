...
classdef InfluenceDistance1 < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1') & STIM.ROIResponseDirect1 & (STIMANAL.SessionEpochsIncludedFinal & 'flag_include=1');
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            rel=STIM.ROIInfluence1;
...
%             flag_divide_by_std = [0]; % 1 divide the response by std. 0 don't divide
            ...
            for i_n = 1:1:numel(neurons_or_control_flag)
                ...
                rel_direct= STIMANAL.NeuronOrControl1 & kkk;
