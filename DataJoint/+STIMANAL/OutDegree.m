...
classdef OutDegree < dj.Imported
    properties
        keySource = EXP2.SessionEpoch & STIM.ROIResponseDirect5;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_group = IMG.PhotostimGroup &   STIM.ROIResponseDirect5 & key;
            photostim_group = fetch(rel_group,'ORDER BY photostim_group_num');
            
            key_ROI=fetch(STIM.ROIResponseDirect5 & key,'ORDER BY photostim_group_num');
