...
classdef Target2AllCorrConcat3 < dj.Computed
    properties
        keySource = (EXP2.SessionEpoch& 'session_epoch_type="spont_photo"') & (EXP2.Session & (EXP2.SessionEpoch & 'session_epoch_type="behav_only"')  & (EXP2.SessionEpoch & LICK2D.ROILick2DContactenatedSpikes)) & STIM.ROIResponseDirect3;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_data = LICK2D.ROILick2DContactenatedSpikes & rel_roi;

            
            %% Loading Data
            rel_photostim =IMG.PhotostimGroup*(STIM.ROIResponseDirect3) & key;
            ...
            PSTH=cell2mat(fetchn(rel_data,'psth_position_concat_regularreward','ORDER BY roi_number'));
