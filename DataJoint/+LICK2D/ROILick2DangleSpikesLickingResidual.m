...
classdef ROILick2DangleSpikesLickingResidual< dj.Imported
    properties
...
%                 keySource = (EXP2.SessionEpoch*IMG.FOV) & IMG.ROI & EXP2.TrialLickPort & 'session_epoch_type="behav_only"' & EXP2.TrialLickBlock & IMG.Mesoscope;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            fn_computer_Lick2Dangle__LickingResidual(key,self, rel_data,fr_interval,flag_threshold_events,threshold_events_cutoff,dir_current_fig);
