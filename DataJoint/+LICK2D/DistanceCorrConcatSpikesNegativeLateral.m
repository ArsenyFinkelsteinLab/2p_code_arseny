...
classdef DistanceCorrConcatSpikesNegativeLateral < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            if mesoscope_flag==1
                ...
                dir_save_fig = [dir_base  '\Lick2D\population\corr_distance_concat_notmeso_spikes_negatvelateral\'];
