...
psth_position_concat_regularreward=null               : longblob   # Same as above using only regular reward trials
...
classdef ROILick2DContactenatedNeuropil < dj.Imported
    properties
%                 keySource = (EXP2.SessionEpoch*IMG.FOV) & IMG.ROI & EXP2.TrialLickPort & 'session_epoch_type="behav_only"' & EXP2.TrialLickBlock & IMG.Mesoscope;
                        keySource = (EXP2.SessionEpoch*IMG.FOV) & IMG.ROI & EXP2.TrialLickPort & 'session_epoch_type="behav_only"' & EXP2.TrialLickBlock & IMG.ROIdeltaFNeuropil;
