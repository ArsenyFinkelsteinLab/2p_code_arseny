...
classdef ROILick2DmapRewardSpikes < dj.Computed
    properties
%         keySource = (EXP2.SessionEpoch*IMG.FOV) & LICK2D.ROILick2DmapPSTHSpikes - IMG.Mesoscope;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            key_rois1 = fetch(LICK2D.ROILick2DmapPSTHSpikes & key); %self
            key_rois2 = fetch(LICK2D.ROILick2DmapPSTHSpikes & key); %self2
            self2=LICK2D.ROILick2DmapRewardStatsSpikes;
            
            rel=LICK2D.ROILick2DmapPSTHSpikes*LICK2D.ROILick2DmapSpikes*LICK2D.ROILick2DmapPSTHStabilitySpikes*LICK2D.ROILick2DPSTHStatsSpikes;
            ...
            insert(self2,key_rois2); % also populates self2=LICK2D.ROILick2DmapRewardStatsSpikes;
