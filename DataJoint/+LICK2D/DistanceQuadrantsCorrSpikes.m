...
classdef DistanceQuadrantsCorrSpikes < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_save_fig = [dir_base  '\Lick2D\population\corr_distance_quadrants_notmeso\'];
            
            psth_quadrants_odd_even_corr_threshold=[-1, 0, 0.25, 0.5];
