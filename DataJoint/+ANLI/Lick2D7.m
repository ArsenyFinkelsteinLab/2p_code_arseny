...
classdef Lick2D7 < dj.Computed
    properties
        
        keySource = EXP2.SessionEpoch  & IMG.Mesoscope & POP.ROIClusterCorr2;
        
    end
    methods(Access=protected)
        function makeTuples(self, key)
%             n_clust_vector = [20, 100, 500, 1000, 2000, 5000];
                        n_clust_vector = [500, 1000, 2000];
            ...
            for ic = 1:1:numel(n_clust_vector)
                ...
                lick2D_map_onFOV_clusters_corr_meso2(key, flag_plot_clusters_individually, n_clust, M_all);
