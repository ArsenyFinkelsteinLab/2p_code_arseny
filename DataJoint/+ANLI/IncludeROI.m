...
classdef IncludeROI < dj.Computed
    properties
        %         keySource = EXP.Session & EPHYS.TrialSpikes
        keySource = (EXP2.Session  & IMG.ROI & IMG.ROISpikes);
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            key.threshold_for_event = 3;
            %             key.minimal_number_of_suprahtreshold_events = 10;
            ...
            frame_rate= ceil(fetch1(IMG.FOV& key , 'imaging_frame_rate'));
            ...
            for iROI = 1:numel(roi_list)
                ...
                Fs=smoothdata(F,'gaussian',running_window*5);
                %                 Fs=F;
                ...
                [~,idx_peaks]=findpeaks(dFF,'MinPeakDistance',frame_rate*2,'MinPeakHeight',key.threshold_for_event);
                ...
                %
                %                 if numel(idx_peaks)>=key.minimal_number_of_suprahtreshold_events
