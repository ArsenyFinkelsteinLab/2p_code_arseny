function PLOTS_Maps2DSelectivity(key, dir_current_fig)
close all;
% clf;
...
if nargin<1
    ...
    dir_current_fig = [dir_base  '\Lick2D\population\selectivity_distance_meso\'];
...
rel_rois=  IMG.ROIGood & (LICK2D.ROILick2DSelectivityStats  & key  & 'selectivity_odd_even_corr>0.5');
...
time_all = M.peaktime_selectivity;
...
a=histogram(M.peaktime_selectivity,time_bins);
...
PSTH = cell2mat(fetchn(rel_psth, 'selectivity', 'ORDER BY roi_number'));
