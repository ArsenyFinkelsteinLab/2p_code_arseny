function PLOTS_MapsClusterCorrThresholded(key, flag_plot_clusters_individually,  M_all, dir_current_fig)
close all;
...
if threshold_for_event==0
    ...
    rel = IMG.ROI &  ((POP.ROIClusterCorrThresholded& key) & 'heirar_cluster_percent>=1')  & IMG.ROIGood ;
    rel1 = ((IMG.ROI*POP.ROIClusterCorrThresholded*IMG.PlaneCoordinates) & IMG.ROIGood & key) & 'heirar_cluster_percent>=1';
end
