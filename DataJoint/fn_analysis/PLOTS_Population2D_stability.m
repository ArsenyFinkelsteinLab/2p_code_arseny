function PLOTS_Population2D_stability
close all;

key = (EXP2.Session & 'session>=1') &  LICK2D.ROILick2DangleSpikes & (LICK2D.ROILick2DmapSpikes) - IMG.Mesoscope;

rel_all=(LICK2D.ROILick2DContactenatedSpikes*LICK2D.ROILick2DangleSpikes & key) & 'goodness_of_fit_vmises>=0.5';
...
r=fetchn(rel_all ,'psth_position_concat_regularreward_odd_even_corr');
