function PLOTS_Maps2Dtheta_distance(key, dir_current_fig, rel_data )
close all;
% clf;
...
rel_rois_selected= rel_roi  & (rel_data  & key  & 'theta_tuning_odd_even_corr>0.5' & 'goodness_of_fit_vmises>0' & 'rayleigh_length>0');
...
rel = (rel_data& rel_rois_selected)*IMG.PlaneCoordinates*IMG.ROI ;
% rel_neuropil = LICK2D.ROILick2DangleNeuropil*IMG.PlaneCoordinates & rel_rois_selected;

rel_all = rel_roi*IMG.PlaneCoordinates;
