...
classdef Dimensionality < dj.Computed
    properties
        
        keySource = LAB.Subject &  POP.SVDSingularValues;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_current_fig = [dir_base  '\Lick2D\dimensionality\'];
            threshold_variance_explained=0.9;
            k=key;
            k.session_epoch_type='spont_only';
            V = fetch(POP.SVDSingularValues & k,'*');
            for i=1:1:numel(V)
