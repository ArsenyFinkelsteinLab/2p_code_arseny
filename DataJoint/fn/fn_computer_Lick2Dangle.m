function fn_computer_Lick2Dangle(key,self, rel_data, fr_interval, flag_threshold_events, threshold_events_cutoff,dir_current_fig)
...
for i_roi=1:1:size(S,1)
    ...
    key_ROI(i_roi).number_of_theta_not_nan =sum(~isnan(theta_firing_rate_smoothed));
