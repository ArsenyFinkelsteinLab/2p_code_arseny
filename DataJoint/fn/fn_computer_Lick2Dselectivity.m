...
for i_roi=1:1:size(S,1)
    ...
    psth_preferred_odd =  nanmean(cell2mat(psth_all( idx_preferred )'),1);
    psth_preferred_even = nanmean(cell2mat(psth_all(idx_preferred)'),1);
   ...
   psth_non_preferred =  nanmean(cell2mat(psth_all(idx_non_preferred)'),1);
    psth_non_preferred_odd =  nanmean(cell2mat(psth_all( idx_non_preferred )'),1);
    psth_non_preferred_even = nanmean(cell2mat(psth_all(idx_non_preferred)'),1);
