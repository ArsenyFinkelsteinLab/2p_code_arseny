function fn_compute_Lick2D_map_and_selectivity2(key,self, rel_data, fr_interval)
...
for i_roi=1:1:size(S,1)
    ...
    for i_x=1:1:numel(x_bins_centers)
        for i_z=1:1:numel(z_bins_centers)
            ...
            [psth_per_position_regular{i_z,i_x}, psth_per_position_regular_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_regular, timespent_min, time);
            [psth_per_position_regular_odd{i_z,i_x}, ~] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_regular & idx_odd_regular, timespent_min, time);
            [psth_per_position_regular_even{i_z,i_x}, ~] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_regular & idx_even_regular, timespent_min, time);
            try
               [psth_per_position_small{i_z,i_x}, psth_per_position_small_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_small, timespent_min_partial, time);
               [psth_per_position_large{i_z,i_x}, psth_per_position_large_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_large, timespent_min_partial, time);
               [psth_per_position_first{i_z,i_x}, psth_per_position_first_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_first, timespent_min_partial, time);
               [psth_per_position_begin{i_z,i_x}, psth_per_position_begin_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_begin, timespent_min_partial, time);
               [psth_per_position_mid{i_z,i_x},  psth_per_position_mid_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_mid, timespent_min_partial, time);
               [psth_per_position_end{i_z,i_x},  psth_per_position_end_stem{i_z,i_x}] = fn_compute_psth_mean_and_stem(psth_all, i_roi, num_trials, idx_bin, idx_end, timespent_min_partial, time);
            catch
            end
...
key_ROI5(i_roi).selectivity_regular_odd_even_corr = r(2);
...
key_ROI5(i_roi).peaktime_selectivity_regular_odd = time(idx_peak);
[~,idx_peak]=max(selectivity_regular_even);
key_ROI5(i_roi).peaktime_selectivity_regular_even = time(idx_peak);
