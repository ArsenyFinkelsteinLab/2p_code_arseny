...
if isempty(TrialsStartFrame) % not mesoscope recordings
    ...
    TrialsStartFrame=fetchn(rel_start_frame,'session_epoch_file_start_frame','ORDER BY session_epoch_file_num');
    trial_num=fetchn(rel_start_frame,'session_epoch_file_num','ORDER BY session_epoch_file_num');
end
