...
classdef ROIInfluence5 < dj.Computed
    properties
...
%         keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1' & IMG.FOVEpoch) & (STIMANAL.SessionEpochsIncluded& 'stimpower=150' & 'flag_include=1') & IMG.Volumetric
                keySource = (EXP2.SessionEpoch & 'flag_photostim_epoch =1' & IMG.FOVEpoch) & IMG.Volumetric & (STIMANAL.SessionEpochsIncluded& 'flag_include=1')
...
%                         allsites_photostim_frames_far = unique(floor(allsites_photostim_frames_far./bin_size_in_frame));
                        ...
                        baseline_frames_clean=allsites_photostim_frames_unique(~ismember(allsites_photostim_frames_unique, [allsites_photostim_frames_near-3, allsites_photostim_frames_near-2, allsites_photostim_frames_near-1, allsites_photostim_frames_near, allsites_photostim_frames_near+1]));
