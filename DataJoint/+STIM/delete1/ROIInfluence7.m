...
classdef ROIInfluence7 < dj.Computed
    properties
...
%                         allsites_photostim_frames_far = unique(floor(allsites_photostim_frames_far./bin_size_in_frame));
                        ...
                        baseline_frames_clean=allsites_photostim_frames_unique(~ismember(allsites_photostim_frames_unique, [ allsites_photostim_frames_near-2, allsites_photostim_frames_near-1, allsites_photostim_frames_near, allsites_photostim_frames_near+1]));
                        baseline_frames_clean=baseline_frames_clean(~ismember(baseline_frames_clean, [ target_photostim_frames-2, target_photostim_frames-1, target_photostim_frames, target_photostim_frames+1]));
...
%                         end
                        ...
                        target_photostim_frames_clean=target_photostim_frames(~ismember(target_photostim_frames, [ allsites_photostim_frames_near-2, allsites_photostim_frames_near-1, allsites_photostim_frames_near, allsites_photostim_frames_near+1]));
