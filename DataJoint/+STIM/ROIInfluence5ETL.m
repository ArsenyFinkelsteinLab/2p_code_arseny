...
classdef ROIInfluence5ETL < dj.Computed
    properties
        keySource =  (EXP2.SessionEpoch & 'flag_photostim_epoch =1' & IMG.FOVEpoch) & IMG.Volumetric & (STIMANAL.SessionEpochsIncluded& 'flag_include=1') & IMG.ROIPositionETL & (EXP2.Session*EXP2.SessionID);
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            minimal_number_of_clean_trials=15; %to include; trials that are not affected by random stimulations of nearby targets
