...
classdef ROIResponseDirect3 < dj.Imported
    properties
        %         keySource = IMG.PhotostimGroup;
        keySource = EXP2.SessionEpoch & 'flag_photostim_epoch =1' & (IMG.FOV & STIM.ROIInfluence3) & (STIMANAL.SessionEpochsIncludedFinal & 'flag_include=1');
    end
