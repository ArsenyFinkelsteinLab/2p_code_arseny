...
classdef ROIClusterCorrDistance < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            dir_current_figure = [dir_base  '\Mesoscope\Correlation_remove1PC\'];
...
%             box off;
            ...
            dir_save_figure = [dir_current_figure 'anm' num2str(s.subject_id) '\'];
