...
classdef ROISVDNeuropil < dj.Computed
    properties
        
        keySource =(EXP2.SessionEpoch & IMG.ROIdeltaFNeuropil & STIMANAL.MiceIncluded) - EXP2.SessionEpochSomatotopy;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_data1 = IMG.ROIdeltaFNeuropil-IMG.ROIBad;
            self2 = POP.SVDSingularValuesNeuropil;
            self3 = POP.SVDTemporalComponentsNeuropil;
