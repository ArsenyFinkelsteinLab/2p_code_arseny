...
classdef ROISVDNeuropilSubtr < dj.Computed
    properties
        
        keySource =(EXP2.SessionEpoch & IMG.ROIdeltaFNeuropilSubtr & STIMANAL.MiceIncluded) - EXP2.SessionEpochSomatotopy;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_data1 = (IMG.ROIdeltaFNeuropilSubtr & key)-IMG.ROIBad;
            self2 = POP.SVDSingularValuesNeuropilSubtract;
            self3 = POP.SVDTemporalComponentsNeuropilSubtract;
