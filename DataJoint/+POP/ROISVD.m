...
classdef ROISVD < dj.Computed
    properties
        keySource =(EXP2.SessionEpoch & IMG.ROIdeltaF & STIMANAL.MiceIncluded)- EXP2.SessionEpochSomatotopy;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            self2 = POP.SVDSingularValues;
            self3 = POP.SVDTemporalComponents;
