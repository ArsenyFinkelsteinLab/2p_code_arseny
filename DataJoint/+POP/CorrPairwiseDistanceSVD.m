...
classdef CorrPairwiseDistanceSVD < dj.Computed
    properties
        keySource =(EXP2.SessionEpoch & IMG.ROIdeltaF & STIMANAL.MiceIncluded & IMG.PlaneCoordinates)- EXP2.SessionEpochSomatotopy;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            dir_base = fetch1(IMG.Parameters & 'parameter_name="dir_root_save"', 'parameter_value');
            dir_save_fig = [dir_base  '\POP\corr_distance\dff\'];
