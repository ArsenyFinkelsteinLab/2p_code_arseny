function [ X_firing_rate, X_firing_rate_smoothed, prefered_X,Rayleigh_length] ...
    = fn_compute_generic_1D_tuning2 ...
    (X_timespent_binned, X_spikes_binned, X_bins_vector_of_centers, time_spent_minimum_for_1D_bins, smoothing_window_1D,perform_circular_smoothing,compute_Rayleigh_length)


% Computing a 1D-tuning curve
%--------------------------------------------------------------------------
X_firing_rate = (X_spikes_binned./X_timespent_binned);
