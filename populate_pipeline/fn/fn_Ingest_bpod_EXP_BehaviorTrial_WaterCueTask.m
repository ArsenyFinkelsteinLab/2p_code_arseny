function [data_BehaviorTrial, data_TrialName] = fn_Ingest_bpod_EXP_BehaviorTrial_WaterCueTask (obj, key, iTrials,obj_trial, data_BehaviorTrial, early_lick, go_t, action_event_time, outcome_types, data_TrialName)
